...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Lista de los tipos de archvos</h1>
        </div>
            ...
            <div class="row" id="tabla">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                <table class="table table-striped" id="tblTiposArchivos" width="100%">
                                    <thead>
                                        <tr>
...
<script src="scripts/tiposArchivos.js"></script>